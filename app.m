...
% Last Modified by GUIDE v2.5 20-Jun-2018 10:20:38
...
startMenu = imread('img\startMenu.PNG');
startMenuImg = image(startMenu);
im.ButtonDownFcn = @gotoIntro(hObject);
axis off;

function goToIntro(hObject)
    handles = guidata(hObject);
    set(handles.consolelog, 'String', 'left');
    handles.introduction;
    axes(handles.introduction);
    introduction = imread('img\introduction.PNG');
    introductionImg = image(introduction);
    axis off;
    axis image;
